		...
		<div class="row">
			...
			<div class="col-lg-12">
				<h4 class="title-fuction">Danh sách 
					<?php if(in_array('chucnangkhac-themcauhinhkhac',$arr_route)): ?>
						<a href="<?php echo e(route('addsettingOthers')); ?>"><img src="<?php echo e(asset('images/general/add.png')); ?>"></a>
					<?php endif; ?>
				</h4>
					...
					<table class="table table-hover">
					    ...
					    <?php if(!empty($data)): ?>
						     ...
						     <tr>
						      ...
						      <td>
									<?php if(in_array('chucnangkhac-suacauhinhkhac',$arr_route)): ?>
								       <a class="btn-edit" href="<?php echo e(route('editsettingOthers',['id'=>$val->id])); ?>"><img src="<?php echo e(asset('images/general/edit.png')); ?>"></a>
									<?php endif; ?>
									<?php if(in_array('chucnangkhac-xoacauhinhkhac',$arr_route)): ?>
								       <a class="btn-delete" href="<?php echo e(route('deletesettingOthers',['id'=>$val->id])); ?>" onclick="return confirm('Bạn có chắc chắn muốn xóa ?')"> <img src="<?php echo e(asset('images/general/remove.png')); ?>"></a>
									<?php endif; ?>
						      </td>  
						    </tr>
					    	<?php endforeach; ?>
