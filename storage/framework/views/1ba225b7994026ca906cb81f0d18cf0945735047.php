...
<?php $__env->startSection('content'); ?>
                ...
                <div class="col-lg-offset-2 col-lg-9">
                    <form class="form-horizontal" method="post" action="">
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <select class="select2 narrow min_hour_day_normal">
                                    <?php for($i = 0.5; $i < 4.5; $i += 0.5): ?>
                                        <option value="<?php echo e($i); ?>" <?php echo e($setting_overtime->min_hour_day_normal == $i ? 'selected' : ''); ?>><?php echo e($i); ?></option>
                                    <?php endfor; ?>
                                </select>
                                <script>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <select class="select2 narrow max_hour_day_normal">
                                    <?php for($i = 0.5; $i < 4.5; $i += 0.5): ?>
                                        <option value="<?php echo e($i); ?>" <?php echo e($setting_overtime->max_hour_day_normal == $i ? 'selected' : ''); ?>><?php echo e($i); ?></option>
                                    <?php endfor; ?>
                                </select>
                                <script>
                                    $(document).ready(function() {
                            ...
                            <div class="col-sm-2">
                                <select class="select2 narrow min_hour_day_holiday">
                                    <?php for($i = 0.5; $i < 12.5; $i += 0.5): ?>
                                        <option value="<?php echo e($i); ?>" <?php echo e($setting_overtime->min_hour_day_holiday == $i ? 'selected' : ''); ?>><?php echo e($i); ?></option>
                                    <?php endfor; ?>
                                </select>
                                <script>
                                    $(document).ready(function() {
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <select class="select2 narrow max_hour_day_holiday">
                                    <?php for($i = 0.5; $i < 12.5; $i += 0.5): ?>
                                        <option value="<?php echo e($i); ?>" <?php echo e($setting_overtime->max_hour_day_holiday == $i ? 'selected' : ''); ?>><?php echo e($i); ?></option>
                                    <?php endfor; ?>
                                </select>
                                <script>
                                    $(document).ready(function() {
                        ...
                        <div class="form-group hidden">
                            ...
                            <div class="col-sm-2">
                            <input type="text" name="timesheet_x_day" class="form-control input-sm" maxlength="2" onkeyup="this.value=this.value.replace(/[^\d]/,'')" value="<?php echo e($setting_overtime->timesheet_x_day); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-5 control-label">Số ngày tối đa làm tiến độ dự án <span class="required">*</span></label>
                            <div class="col-sm-2">
                            <input type="text" name="days_short" class="form-control input-sm" maxlength="2" onkeyup="this.value=this.value.replace(/[^\d]/,'')" value="<?php echo e($setting_overtime->days_short); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-5 control-label">Số ngày tối đa làm thường xuyên lâu dài <span class="required">*</span></label>
                            <div class="col-sm-2">
                            <input type="text" name="days_long" class="form-control input-sm" maxlength="2" onkeyup="this.value=this.value.replace(/[^\d]/,'')" value="<?php echo e($setting_overtime->days_long); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-5 control-label">Cho phép báo cáo khi đang chờ phê duyệt <span class="required">*</span></label>
                            <div class="col-sm-2">
                                <input type="checkbox" <?php if($setting_overtime->report_permission == 1): ?> checked <?php endif; ?> value="1" name="report_permission" style="position: relative; top:5px;"> 
                            </div>
                        </div>
                        <div class="form-group">
    ...
    <script>
        function settingOvertime(){
            ...
            $.ajax({
                method: "POST",
                url: '<?php echo e(url("toh_hrm/api/setting-overtime")); ?>',
                data:data, 
                dataType: 'json',
                // beforeSend: function() {
