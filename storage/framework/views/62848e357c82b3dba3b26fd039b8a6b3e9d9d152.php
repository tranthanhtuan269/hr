...
<?php $__env->startSection('title', 'Chấm công đi làm'); ?>
				...
				<div class="form-group col-lg-12">
					...
					<div class="col-sm-9">
						<select name="filter" class="form-control">
			                ...
			                <option value="1" <?php if(Input::get('filter') == '1'): ?> selected="selected" <?php endif; ?>> Danh sách còn phép</option>
			                <option value="2" <?php if(Input::get('filter') == '2'): ?> selected="selected" <?php endif; ?>> Danh sách đủ phép </option>
			                <option value="3" <?php if(Input::get('filter') == '3'): ?> selected="selected" <?php endif; ?>> Danh sách vượt phép</option>
						</select>
					</div>
				</div>
				<div class="form-group col-lg-12">
	        ...
	        <table>
	            ...
	            <?php if(!empty($data)): ?>
					<?php foreach($data as $val): ?>
					   <tr>
						<th><?php echo e(str_limit( $val->fullname, $limit = 30, $end = '...')); ?></th>
						<?php for($i = 1 ; $i <= $number ; $i++): ?>
						    <?php if( !empty($val->type[$i]) ): ?>
								<?php
							...
							<?php endif; ?>
						<?php endfor; ?>
						<td style="font-weight: bold;"><?php echo e($val->param); ?></td>
						</tr>
					<?php endforeach; ?>
	            <?php endif; ?>
 	...
 	<div class="col-lg-3">
	 	<ul>
			...
			<?php foreach($note as $key => $val): ?>
	                <li><?php echo e($val->symbol); ?>  - <?php echo e($val->title); ?></li>
				<?php if($key == 0): ?>	
