		...
		<div class="col-lg-10">
				...
				<div class="row">
					<form action="" method="get">
						...
						<div class="form-group col-lg-6">
							...
							<div class="col-sm-6">
                                <input type="text" class="datepicker form-control" id="dayLatches" value="<?php echo e(BatvHelper::getDayLatches( $selectMonth,$selectYear )); ?>">
							</div>
						</div>
				...
				<h4 class="title-fuction">
					...
					<div class="pull-right" >
						<?php if( empty($data) || $data[0]->status ==1): ?>
							<button type="button" class="btn btn-sm btn-orange special bonus"><img src="<?php echo e(asset('images/general/calculator.png')); ?>"></button>
						<?php endif; ?>
					</div>
				</h4>
						    ...
						    <?php if(!empty($data)): ?>
					    		...
					    		?>
						     	<?php foreach($data as $val): ?>
						    		...
						    		?>
									     <tr>
									      	<td class="text-nowrap" scope="row" style="min-width: 210px;"> <?php echo e(str_limit( $val->fullname, $limit = 35, $end = '...')); ?> </td> 
						    	...
						    	<?php endforeach; ?>
				    					<tr style="background: rgba(255, 0, 0, 0.56);">
				    						...
				    						<td><b><?php echo e(BatvHelper::formatPrice($total_holiday_bonus+$total_work_bonus+$total_lunch_allowance+$total_travel_allowance+$total_parking_fee_allowance+$total_phone_allowance+$total_management_allowance+$total_other_tax_allowance+$total_laptop_allowance+$total_movement_allowance)); ?></b></td>
				    					</tr>
						    <?php endif; ?>
				        </tbody>
				    </table>
			...
			<script type="text/javascript">
				...
				$('body').on('click','.special.bonus',function(){
					...
					var link = "<?php echo e(route('getAllowanceAjax')); ?>";
