...
<?php $__env->startSection('content'); ?>
                    ...
                    <tbody>
                        <?php foreach($pending as $key => $value): ?>
                            <tr>
                                ...
                                <td><?php echo e(BatvHelper::formatDate($value->created_at, "Y-m-d", "d/m/Y", "H:i:s", false)); ?></td>
                                <td>
                                    <?php if($value->type == 1): ?>
                                        Làm tiến độ dự án
                                ...
                                <td class="text-center">
                                    <?php if($value->status == 1): ?>
                                        <button type="button" data-days-config='<?php echo e($days_config); ?>' data-id-record='<?php echo e($value->id); ?>' class="btn btn-xs btn-primary" data-toggle="modal" data-target="#approvedRegisterOvertime"> Đồng ý </button>
                                        <button type="button" data-id-record='<?php echo e($value->id); ?>' class="btn btn-xs btn-danger" data-toggle="modal" data-target="#rejectRegisterOvertime"> Từ chối </button>
                                    <?php endif; ?>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php if($value->updated_at != ''): ?> 
                                        ...
                                        ?>
                                        Từ <?php echo e(BatvHelper::formatDate($value->updated_at, "Y-m-d", "d/m/Y", "H:i:s", false)); ?> đến 
    ...
    <script>
        ...
        function approvedRegisterOvertime(){
            ...
            $.ajax({
                method: "POST",
                url: '<?php echo e(url("toh_hrm/api/approved-register-overtime")); ?>',
                data:data, 
                dataType: 'json',
                beforeSend: function() {
        ...
        function rejectRegisterOvertime(){
            ...
            $.ajax({
                method: "POST",
                url: '<?php echo e(url("toh_hrm/api/check-reject-register-overtime")); ?>',
                data:data, 
                dataType: 'json',
                beforeSend: function() {
                    $(".ajax_waiting").addClass("loading");
                ...
                success: function (response) {
                    function handling() {
                        ...
                        $.ajax({
                            method: "POST",
                            url: '<?php echo e(url("toh_hrm/api/reject-register-overtime")); ?>',
                            data:data, 
                            dataType: 'json',
                            beforeSend: function() {
                                $(".ajax_waiting").addClass("loading");
