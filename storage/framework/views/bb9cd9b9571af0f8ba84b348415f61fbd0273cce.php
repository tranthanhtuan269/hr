		...
		<div class="col-lg-10">
		      ...
		      <?php endif; ?>
				...
				<h4 class="title-fuction">
					...
					<div class="pull-right" >
						<?php if( empty($data) || $data['status'] ==1): ?>
							<button type="button" class="btn btn-sm btn-orange special salaryOther"><img src="<?php echo e(asset('images/general/calculator.png')); ?>"></button>
						<?php endif; ?>
					</div>
				</h4>
			...
			<script type="text/javascript">
				$('body').on('click','.special.salaryOther',function(){
					...
					var link = "<?php echo e(route('getSalaryOtherAjax')); ?>";
