        ...
        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <?php
                                          ...
                                          ?>
                                            <input type="text"  class="form-control datepicker" name="fillter_date"  required placeholder="Ngày" value="<?php echo e($value); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12">
            ...
            <div class="col-lg-12">
                <h4 class="title-fuction">Danh sách bàn giao thiết bị 			                        
                    <?php if(in_array('thietbi-thembangiaothietbi',$arr_route)): ?>
                    <a href="<?php echo e(route('getTakeDeviceAdd')); ?>"><img src="<?php echo e(asset('images/general/add.png')); ?>"></a>
                    <?php endif; ?>
                </h4>
                    ...
                    <table class="table table-hover">
                        <tbody>
                            ...
                            <tr class="text-center">
                                ...
                                <td> <?php echo e(BatvHelper::formatDate($val->tdp_dateIn,"Y-m-d H:i:s", $formatDate="d/m/Y",$timeFormat="H:i:s",$time=false)); ?></td>
                                ...
                                <td>
                                    <?php if(in_array('thietbi-suabangiaothietbi',$arr_route)): ?>
                                        <a class="btn-edit" href="<?php echo e(route('getTakeDeviceEdit',['id'=>$val->id_device_personnel])); ?>"><img src="<?php echo e(asset('images/general/edit.png')); ?>"></a>
                                    <?php endif; ?>

                                    <?php if(in_array('thietbi-xoabangiaothietbi',$arr_route)): ?>
                                        <a class="btn-delete" href="<?php echo e(route('getTakeDeviceDel',['id'=>$val->id_device_personnel])); ?>" onclick="return confirm('Bạn có chắc chắn muốn xóa ?')"> 
