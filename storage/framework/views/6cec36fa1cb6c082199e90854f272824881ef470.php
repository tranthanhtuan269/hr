    ...
    <div class="col-lg-10">
        ...
        <form action="" method="post">
            <h4 class="title-fuction">
                Thông tin tổng hợp từ <?php echo e(BatvHelper::formatDate($valid_from,'Y-m-d',$formatDate='d/m/Y',$timeFormat='H:i:s',$time=false)); ?> đến <?php echo e(BatvHelper::formatDate($valid_to,'Y-m-d',$formatDate='d/m/Y',$timeFormat='H:i:s',$time=false)); ?>
            ...
            <?php  $total_price = 0; ?>
                <?php if(!empty($expenseGeneral)): ?>
                    <?php foreach($expenseGeneral as $val): ?>
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <?php /* <th class="text-center">Khấu trừ khoản vay</th> */ ?>
                                    <th class="text-center">Tổng</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td class="text-center"><?php echo e(BatvHelper::formatPrice( $total_price )); ?></td>
                                    <td class="text-center"><?php echo e(BatvHelper::formatPrice($column_all)); ?></td>
                                    <?php /* <td class="text-center"><?php echo e(BatvHelper::formatPrice($column_loan)); ?></td> */ ?>
                                    <td class="text-center"><?php echo e(BatvHelper::formatPrice( $total_price +$column_all)); ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <?php
                                    ...
                                    ?>
                                <tr>
                                    <td class="text-nowrap" scope="row" style="text-align: center;"> <?php echo e($stt); ?> </td>
                                    <td><?php echo e($val['title']); ?></td>
                                    <td style="text-align: center;"><?php echo e(BatvHelper::formatDate($val['valid_from'],'Y-m-d',$formatDate='d/m/Y',$timeFormat='H:i:s',$time=false)); ?></td>
                                    <td>
                                        <?php $tmp = 1; ?>
                                    ...
                                    <td style="text-align: center;"><?php echo e(BatvHelper::formatPrice( $price )); ?></td>
                                    <td style="text-align: center;"><?php echo e(BatvHelper::getInfoUser( $val['created_by'] )); ?></td>
                                    <td>
                                                ...
                                                <div class="modal-content clearfix">
                                                    ...
                                                    <div style="padding: 20px;">
                                                        ...
                                                        <div class="form-group  row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <?php echo e(BatvHelper::formatPrice( $val['value'] )); ?> VNĐ 
                                                                <?php if( $val['value_usd'] >0 ): ?>
                                                                    ( <?php echo e(BatvHelper::formatPrice( $val['value_usd'] )); ?> USD )
                                                                <?php endif; ?>
                                                            </div>
                                                        </div>
                                                        <div class="form-group  row">
                                ...
                                <tr style="background: rgba(255, 0, 0, 0.56);text-align: center;">
                                    ...
                                    <td><b><?php echo e(BatvHelper::formatPrice($total_price)); ?></b></td>
                                </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
                            ...
                            <tbody class="detailType">
                                ...
                                <?php foreach($data as $val): ?>
                                    <?php $total_item = $loan = 0; ?>
                                        <?php if( !empty( $others[$val->personnel_id] ) ): ?>
                                            <?php foreach( $others[$val->personnel_id]['income_value'] as $k=>$v ): ?>
                                                <?php if( !empty($v) ): ?>
                                    ...
                                    <tr style="text-align: center;">
                                        <td><input type="checkbox" name="personnel_id[<?php echo e($val->personnel_id); ?>]" value="<?php echo e($val->personnel_id); ?>"  checked></td>
                                        <td class="text-nowrap" scope="row"><a class="btn-edit" href="<?php echo e(route('getPersonnelEdit',['id'=>$val->personnel_id])); ?>"><?php echo e(str_limit( $val->fullname, $limit = 35, $end = '...')); ?></a></td>
                                        <td> 
                                            <?php   
                                                $flag_tmp_1 =  $val->salary_overtime + $val->salary_official_work+$val->salary_trial_work+$val->salary_trainee_work+$val->salary_trainee_parttime_work+$val->salary_parttime_work+$val->management_allowance+ $val->lunch_allowance+ $val->travel_allowance+$val->phone_allowance+$val->movement_allowance+$val->work_bonus-$val->insurance-$val->money_work_late-$val->welfare_fund+$val->parking_fee_allowance+$total_item+$val->other_tax_allowance+$val->laptop_allowance+$val->mulct_money_awol + $val->holiday_bonus-$val->party_fee;   
                                            ...
                                            <?php echo e(BatvHelper::formatPrice($all_company)); ?>

                                            <input type="hidden" name="item[<?php echo e($val->personnel_id); ?>]" value="<?php echo e($all_company); ?>">
                                        </td>
                                        <!-- Tổng nhận -->
                                    </tr>
                                <?php endforeach; ?>
                                <tr style="background: rgba(255, 0, 0, 0.56);text-align: center;">
                                    <td></td>
                                    <td><b>TỔNG HỢP</b></td>
                                    <td><b class="total"><?php echo e(BatvHelper::formatPrice($column_all)); ?></b>
                                    </td>
                                </tr>
                                <?php endif; ?>
                            </tbody>
