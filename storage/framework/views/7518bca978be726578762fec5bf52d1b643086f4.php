					     	...
					     	<?php foreach($data as $val): ?>
							    ...
							    <?php elseif( $val->salary_trial_work> 0 && $val->salary_official_work  == 0 && $val->salary_parttime_work == 0 && $val->salary_trainee_work == 0 ): ?>
					     		...
					     		<?php elseif( $val->salary_trainee_work > 0 && $val->salary_trial_work == 0 && $val->salary_official_work == 0 && $val->salary_parttime_work == 0 ): ?>
								    ...
								    <!-- Nửa này nửa kia -->
								    <?php else: ?>
								    	<?php if( $val->salary_trial_work >0 && ( $val->salary_trainee_work >0 || $val->salary_official_work >0 || $val->salary_parttime_work >0 ) ): ?>
											<?php
								    	...
								    	<?php if( $val->salary_trainee_work >0 && ( $val->salary_official_work >0 || $val->salary_parttime_work >0 ) ): ?>
											<?php
								    	...
								    	<?php endif; ?>
								    	<?php if( $val->salary_parttime_work >0 && $val->salary_official_work >0 ): ?>
										    <tr>
										     	<td class="text-nowrap" scope="row" rowspan="2" style="padding: 25px 0;"> <?php echo e(str_limit( $val->fullname, $limit = 35, $end = '...')); ?> </td> 
												<td><?php echo e(BatvHelper::formatPrice( ( $val->salary_parttime_work ) )); ?></td>
												<td rowspan="2" style="padding: 25px 0;"><?php echo e(BatvHelper::formatPrice($val->salary_overtime)); ?></td>
												<td rowspan="2" style="padding: 25px 0;"><?php  if( $val->money_work_late > 0 ) echo "-"; ?><?php echo e(BatvHelper::formatPrice($val->money_work_late)); ?></td>
												<td rowspan="2" style="padding: 25px 0;"><?php echo e(BatvHelper::formatPrice($val->mulct_money_awol )); ?></td>
												<td rowspan="2" style="padding: 25px 0;"><?php echo e(BatvHelper::formatPrice($val->salary_overtime + $val->salary_parttime_work+$val->salary_official_work-$val->money_work_late+$val->mulct_money_awol)); ?></td>
