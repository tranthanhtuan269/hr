						    	...
						    	<?php $tmp=1; ?>
							     ...
							     <tr>
							      	...
							      	<td style="text-align: left; padding-left: 30px;">
							      		<?php echo e(str_limit( $val->fullname, $limit = 35, $end = '...')); ?>

								    </td>
								    <td>
				                        <?php if(in_array('chucnangkhac-xoacauhinhmienchamcong',$arr_route)): ?>
								       		<a class="btn-delete" href="<?php echo e(route('deleteExceptionalAttendance',['id'=>$val->id])); ?>" onclick="return confirm('Bạn có chắc chắn muốn xóa ?')"> 
