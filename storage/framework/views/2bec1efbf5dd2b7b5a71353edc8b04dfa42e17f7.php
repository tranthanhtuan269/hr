...
<div class="row setting_salary">
		...
		<div class="col-lg-10">
			<h4 class="title-fuction">Cấu hình KI(phong trào)
<!-- 				<?php if(in_array('luongthuong-themcauhinhkihieusuatnam',$arr_route)): ?>
			...
			<div class="row">
				...
				<div class="col-sm-12">
					<h4 class="title-fuction">Danh sách nhân viên tích cực tham gia các hoạt động, phong trào công ty năm <?php echo e($year); ?></h4>
						...
						<?php endif; ?>
						<form class="row" action="<?php echo e(route('postSettingConfigKiRules')); ?>" method="post">
							...
							<div class="col-sm-4">
								<input type="number" name="ki_performance" placeholder="KI phong trào(%)" class="form-control" style="height: 30px;" required step="0.01">
					    ...
					    <table class="table table-bordered table-striped">
					        <thead>
					            <tr>
					                ...
					                <th class="text-center">KI phong trào(%)</th>
...
<script type="text/javascript">
	...
	function doneEditKi(id) {
	    ...
	    var link = "<?php echo route('editKIRulesAjax'); ?>";
        var data = {
            ki: ki,
            personnel_id: id,
            year:year,
	...
	function delItemEditKi(id) {
	    var year = $('input[name="year"]').val();
	    var link = "<?php echo route('delKIRulesAjax'); ?>";
        var data = {
            personnel_id: id,
            year:year,
        };
