    ...
    <div class="col-lg-10">
        ...
        <form class="form-horizontal" method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="form-group curency">
                ...
                <div class="col-sm-6">
                    <div class="checkbox">
                      <label><input type="checkbox" value=""  <?php if($data->value_usd > 0): ?> checked <?php endif; ?>>Chọn</label>
                    </div>
                </div>
            </div>
            <div class="form-group usd  <?php if($data->value_usd == 0): ?> hidden <?php endif; ?> ">
                <label class="col-sm-4 control-label">Giá trị (USD)<span class="required">*</span></label>
                <div class="col-sm-6">
                    <input type="text" onkeyup="format_curency_general( this.value,'formatResult','result_usd' );" id="formatResult" class="form-control" value="<?php echo e(old('value_usd',isset($data->value_usd) ? BatvHelper::formatPriceSpecial($data->value_usd) : null )); ?>" >
                    <input type="hidden" name="value_usd" id="result_usd" value="<?php echo e(old('value_usd',isset($data->value_usd) ? $data->value_usd : null )); ?>">
            ...
            <div class="form-group vnd">
                ...
                <div class="col-sm-6">
                    <input type="text" onkeyup="format_curency( this.value );" class="form-control" id="numFormatResult" value="<?php echo e(old('value',isset($data->value) ? BatvHelper::formatPriceSpecial($data->value) : null )); ?>" required <?php if($data->value_usd > 0): ?> disabled <?php endif; ?>>
                    <input type="hidden" name="value" id="result" value="<?php echo e(old('value',isset($data->value) ? $data->value : null )); ?>">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-4 control-label"> Mô tả</label>
                <div class="col-sm-6">
                    <textarea rows="4" onkeydown="expandtext(this);" name="description" class="form-control"><?php echo e(old('description',isset($data->description) ? $data->description : null )); ?></textarea>
                </div>
            </div>
            <div class="form-group">
                    ...
                    <?php if(!empty($listFunds)): ?>
                        <?php foreach($listFunds as $fund): ?>
                            <div class="checkbox bypersonnel_notselect">
                                <div class="col-sm-3"><input type="checkbox"  id="<?php echo e($fund->id); ?>" name="fund[<?php echo e($fund->id); ?>]" value="<?php echo e($fund->id); ?>" <?php echo ( isset($fund->selected) && $fund->selected==1 )?"checked":""; ?> ><?php echo e($fund->title); ?></div> 
                                <div class="col-sm-6">
                                    <input type='text' name="percent[<?php echo e($fund->id); ?>]" value="<?php echo e(isset($fund->percent) ? $fund->percent  : null); ?>" > %  
                                </div>
                            </div>
                        <?php endforeach; ?>
                    <?php endif; ?>
            ...
            <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        ...
                        <select name="personnel" class="form-control select2 narrow wrap">
                            ...
                            <option value="<?php echo e($personnel->id); ?>" <?php if( $personnel->id == $data->created_by ): ?> selected="selected" <?php endif; ?> ><?php echo e($personnel->name); ?></option>
                            <?php endforeach; ?>
                        </select>
                        <?php endif; ?>
                    </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input id="from" type="text" pattern="\d{1,2}/\d{1,2}/\d{4}" class="datepicker form-control" name="valid_from" value='<?php echo e(BatvHelper::formatDate($data->valid_from,"Y-m-d", $formatDate="d/m/Y",$timeFormat="H:i:s",$time=false)); ?>'  required>
                </div>
            </div>
            <div id="day_boxing" class="day_boxing form-group">
                ...
                <div class="col-sm-6">
                    <input id="to" type="text" pattern="\d{1,2}/\d{1,2}/\d{4}" class="datepicker form-control" name="valid_to" value='<?php echo e(BatvHelper::formatDate($data->valid_to,"Y-m-d", $formatDate="d/m/Y",$timeFormat="H:i:s",$time=false)); ?>' required>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-4 control-label">Link file đính kèm</label>
                <div class="col-sm-6">
                    <a href="<?php echo e($data->link_dropbox); ?>" style="position: relative;top: 8px;" target="_blank"><?php echo e($data->link_dropbox); ?></a>
                </div>
            </div>
            <div class="form-group">
