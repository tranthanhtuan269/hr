...
<?php $__env->startSection('content'); ?>  
    ...
    <div class="row">
        ...
        <div class="col-lg-10">
            <h4 class="title-fuction">
                ...
                <?php if($user_id == 1 && count($list_personnel_loan_capital) > 0): ?>
                            ...
                            <div class="col-sm-8">
                                <select name="personnel_id" id="selectPersonnel" class="form-control select2 narrow wrap" >
                                    ...
                                    <?php if(!empty($list_all_personnel)): ?>
                                        <?php foreach($list_all_personnel as $value): ?>
                                        <option value="<?php echo e($value->id); ?>" <?php if($value->id == Request::get('personnel_id')): ?> <?php echo e("selected"); ?> <?php endif; ?>><?php echo e($value->fullname); ?></option>
                                        <?php endforeach; ?>
                                    <?php endif; ?>
                                </select>
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <div class="col-sm-8">	
                                <select name="status" class="form-control" style="width: 100%;height: 29px; font-size: 13px !important;">
                                    <option value="-1" <?php if(Request::get('status') == -1): ?> selected <?php endif; ?>> -- Tất cả -- </option>
                                    <option value="0" <?php if(Request::get('status') == 0): ?> selected <?php endif; ?>> Xem xét yêu cầu vay</option>
                                    <option value="1" <?php if(Request::get('status') == 1): ?> selected <?php endif; ?>> Phê duyệt </option>
                                    <option value="2" <?php if(Request::get('status') == 2): ?> selected <?php endif; ?>> Đã duyệt </option>
                                    <option value="3" <?php if(Request::get('status') == 3): ?> selected <?php endif; ?>> Đã hủy </option>
                                    <option value="4" <?php if(Request::get('status') == 4): ?> selected <?php endif; ?>> Đã hoàn tất thanh toán </option>
                                </select>
                            </div>
                        </div>
            ...
            <?php endif; ?>
                <?php if(count($list_personnel_loan_capital) > 0): ?>
                    <table class="table table-bordered table-manager">
                            <thead>
                                <tr>
                                    ...
                                    <?php /* <th class="text-center">L/s trả chậm<br> (% năm)</th> */ ?>
                            ...
                            <tbody>
                                ...
                                <?php foreach($list_personnel_loan_capital as $personnel): ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <?php if($personnel->max_money != null): ?>
                                                <?php echo e(number_format($personnel->max_money)); ?>
                                        ...
                                        <td class="text-center">
                                            <?php if($personnel->month_time != null): ?>
                                                <?php echo e($personnel->month_time); ?>
                                        ...
                                        <td class="text-center">
                                            <?php if($personnel->disbursement_date_by_user != '0000-00-00'): ?>
                                                <?php echo e(BatvHelper::formatDate($personnel->disbursement_date_by_user ,'Y-m-d','d/m/Y','H:i:s',false)); ?>
                                        ...
                                        <td class="text-center">
                                            <?php if($personnel->disbursement_date != '0000-00-00'): ?>
                                                <?php echo e(BatvHelper::formatDate($personnel->disbursement_date ,'Y-m-d','d/m/Y','H:i:s',false)); ?>
                                        ...
                                        <td class="text-center">
                                            <?php if($personnel->disbursement_date != '0000-00-00'): ?>
                                                ...
                                                ?>
                                                <?php echo e(BatvHelper::formatDate($start_month_pay ,'Y-m-d','d/m/Y','H:i:s',false)); ?>
                                        ...
                                        <td class="text-center">
                                            <?php if($personnel->interest_rate != null): ?>
                                                <?php echo e($personnel->interest_rate); ?>

                                            <?php else: ?>
                                                <?php echo e($config_loan_capital->interest_rate); ?>

                                            <?php endif; ?>
                                        </td>
                                        
                                        <td class="text-center">
                                            <?php if($personnel->preferential_interest_rate != null): ?>
                                                <?php echo e($personnel->preferential_interest_rate); ?>

                                            <?php else: ?>
                                                <?php echo e($config_loan_capital->preferential_interest_rate); ?>

                                            <?php endif; ?>
                                        </td>
                                        <td class="text-center">
                                            <?php if($personnel->count_month_preferential != null): ?>
                                                <?php echo e($personnel->count_month_preferential); ?>

                                            <?php else: ?>
                                                <?php echo e($config_loan_capital->count_month_preferential); ?>

                                            <?php endif; ?>
                                        </td> 
                                        <?php /* <td class="text-center">
                                            <?php if($personnel->deferred_interest != null): ?>
                                                <?php echo e($personnel->deferred_interest); ?>

                                            <?php else: ?>
                                                <?php echo e($config_loan_capital->deferred_interest); ?>

                                            <?php endif; ?>
                                        </td>  */ ?>
                                        <td class="text-center">
                                            <a href="javascript:void(0)" data-status_file='<?php echo e($personnel->status_file); ?>' data-loan_capital_id='<?php echo e($personnel->loan_capital_id); ?>' data-file='<?php echo e($personnel->file); ?>' data-toggle="modal" data-target="#reviewFile" style="width: 100%"><i class="fa fa-file-text" aria-hidden="true"></i></a>
                                        </td>
                                        <td class="text-center">
                                            <?php if($personnel->status == 2): ?>
                                                <a <?php if($personnel->loan_capital_id != null && $personnel->status == 2 || $personnel->status == 4): ?> href="<?php echo e(route('detailLoanCapital', ['loan_capital_id' => $personnel->loan_capital_id])); ?>"  target="_blank" <?php elseif($personnel->status == 3): ?>  href="javascript:void(0)" data-toggle="modal" data-target="#alertModalCancel"  <?php else: ?> href="javascript:void(0)" data-toggle="modal" data-target="#alertModal"  <?php endif; ?> ><i class="fa fa-info-circle"></i></a>
                                            <?php else: ?>
                                                <a 
                                                data-personnel_id='<?php echo e($personnel->personnel_id); ?>' 
                                                data-loan_capital_id='<?php echo e($personnel->loan_capital_id); ?>' 
                                                data-fullname='<?php echo e($personnel->fullname); ?>' data-score='<?php echo e($personnel->score_faith); ?>' 
                                                data-max_money='<?php echo e($personnel->max_money); ?>' 
                                                data-preferential_interest_rate='<?php echo e($personnel->preferential_interest_rate); ?>' 
                                                data-month_time='<?php echo e($personnel->month_time); ?>' 
                                                data-note='<?php echo e($personnel->note); ?>' 
                                                data-loan_purpose='<?php echo e($personnel->loan_purpose); ?>' 
                                                data-another_purpose='<?php echo e($personnel->another_purpose); ?>' 
                                                data-disbursement_form='<?php echo e($personnel->disbursement_form); ?>' 
                                                data-info_receive_disbursement='<?php echo $personnel->info_receive_disbursement; ?>'
                                                data-pay='<?php echo e($personnel->pay); ?>' 
                                                data-disbursement_date_by_user='<?php echo e(BatvHelper::formatDate($personnel->disbursement_date_by_user,'Y-m-d', 'd/m/Y', 'H:i:s', false)); ?>' 
                                                data-file='<?php echo e($personnel->file); ?>' 
                                        ...
                                        <td class="text-center">
                                            <?php if($personnel->partial_settlement == 1 && $personnel->status == 2): ?>
                                                <i class="fa fa-check" aria-hidden="true" style="color:green"></i>
                                            <?php endif; ?>
                                        </td>
                                        <td class="text-center">
                                            <?php if($personnel->final_settlement == 1 && $personnel->status == 2): ?>
                                                <i class="fa fa-check" aria-hidden="true" style="color:green"></i>
                                            <?php endif; ?>
                                        </td>
                                        <td class="admin-approved">
                                            <?php if($personnel->status == 0): ?>
                                                <div class="text-center">
                                                    <?php if(in_array('xet-diem-tin-nhiem',$arr_route)): ?>
                                                     <a 
                                                        data-personnel_id='<?php echo e($personnel->personnel_id); ?>' 
                                                        data-loan_capital_id='<?php echo e($personnel->loan_capital_id); ?>' 
                                                        data-fullname='<?php echo e($personnel->fullname); ?>' data-score='<?php echo e($personnel->score_faith); ?>' 
                                                                    ...
                                                                    <div class="col-sm-12">
                                                                        ...
                                                                        <?php /* <div class="form-group clearfix">
                                                                          <div style="color:red;font-weight:600;font-style:italic">
                                                                            CHÚ Ý: Nếu điểm tín nhiệm của nhân viên được xét nhỏ hơn <?php echo e($config_loan_capital->score_min); ?> (điểm tiêu chuẩn mà công ty quy định) thì nhân viên sẽ không được duyệt vay vốn.
                                                                          </div>
                                                                        </div> */ ?>
                                                                    </div>
                                            ...
                                            <?php if($personnel->status == 1 && $user_id == 1): ?>
                                                ...
                                                <?php endif; ?>
                                            <?php elseif($personnel->status == 1 && in_array('xet-diem-tin-nhiem',$arr_route)): ?>
                                                <div class="text-center">
                                            ...
                                            <div class="text-center">
                                                <?php /* <div href="#" class="choduyet" style="cursor: inherit;padding: 4.48px 42px;">Chờ duyệt</div>
                    ...
                    <div class="col-lg-12 text-right">
                        <?php echo e($list_personnel_loan_capital->appends(Request::all())->links()); ?> 
                    </div>
                <?php else: ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group clearfix">
                                ...
                                <span class="score_min"></span>
                                <div class="txt_status"></div>
                                <?php /* (<?php echo e($personnel->score); ?>/<?php echo e($config_loan_capital->score_min); ?>) */ ?>
                                <?php /* <?php if($personnel->score < $config_loan_capital->score_min): ?>
                                ...
                                <?php endif; ?> */ ?>
                                <?php /* <input class="form-control input-sm" name="score" type="number" value=""  required min="0"  > */ ?>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group clearfix">
    ...
    <script>  
        ...
        $(document).ready(function(){
            ...
            $(".admin-approved a[data-loan_capital_id=<?php echo e(Request::get('loan_capital_id')); ?>]").trigger("click");   
        });
            ...
            $.each(file, function(key,value){
                if (value) {
                    ...
                    if (ext != "png" && ext != "jpeg" && ext != "jpg" && ext != "gif" && ext != "webp") {
                        var image_path = '<div class="col-sm-3 form-group text-center"><a href="'+ "<?php echo e(url('/images')); ?>" + "/" +value +'" target="_blank"><img style="max-width: 100%;height:75px" src="<?php echo e(asset("images/general/document.png")); ?>"><div class="dz-filename"><span>'+ value +'</span></div></a></div>';
                    } else {
                        var image_path = '<div class="col-sm-3 form-group text-center"><a href="'+ "<?php echo e(url('/images')); ?>" + "/" +value +'" target="_blank"><img style="max-width: 100%;height:75px" src="'+ "<?php echo e(url('/images')); ?>" + "/" +value +'"><div class="dz-filename"><span>'+ value +'</span></div></a></div>';
                    }
        ...
        $(document).on('click','.approved-loan-capital',function(e){
            ...
            $.ajax({
                method: "POST",
                url: '<?php echo e(route("list-loan-capital-history")); ?>',
                data:data, 
                dataType: 'json',
                beforeSend: function() {
            ...
            $.each(file, function(key,value){
                if (value) {
                    ...
                    // var image_path = '<div class="col-sm-3"><a href="'+ "<?php echo e(url('/images')); ?>" + "/" +value +'" target="_blank"><img style="max-width: 100%;height:75px" src="'+ "<?php echo e(url('/images')); ?>" + "/" +value +'"></a></div>';
                    $('#approvedLoanCapital .file').append(image_path);
                }
            });

            if (score || max_money || preferential_interest_rate || month_time) {
                if (score < <?php echo e($config_loan_capital->score_min); ?>) {
                ...
                $('#approvedLoanCapital span.score_min').html('('+ score + '/<?php echo e($config_loan_capital->score_min); ?>)');
        ...
        $(document).on('click','.approved-loan-capital-view-only',function(e){
            ...
            if (score || max_money || preferential_interest_rate || month_time) {
                ...
                $('#approvedLoanCapitalViewOnly span.score_min').html('('+ score + '/<?php echo e($config_loan_capital->score_min); ?>)');
        ...
        $(document).on('click','.review-score',function(){
            ...
            if (score || max_money || preferential_interest_rate || month_time) {
                ...
                $('#reviewScore span.score_min').html('('+ score + '/<?php echo e($config_loan_capital->score_min); ?>)');
        ...
        function handling(data){
            $.ajax({
                method: "POST",
                url: '<?php echo e(url("toh_hrm/api/approved-loan-capital")); ?>',
                data:data, 
                dataType: 'json',
                beforeSend: function() {
                    $(".ajax_waiting").addClass("loading");
        ...
        function approvedLoanCapital(){
            ...
            if (status == 2) {
                ...
                var rest_fund_loan_capital = <?php echo e($rest_fund_loan_capital); ?>;
                var data = {
        ...
        function reviewScore(){
            Swal.fire({
                ...
                if(result.value){   
                    ...
                    $.ajax({
                        method: "POST",
                        url: '<?php echo e(url("toh_hrm/api/review-score")); ?>',
                        data:data, 
                        dataType: 'json',
                        beforeSend: function() {
                            $(".ajax_waiting").addClass("loading");
        ...
        function remindMonthLoanCapital(){
            Swal.fire({
                ...
                if(result.value){   
                    ...
                    $.ajax({
                        method: "POST",
                        url: '<?php echo e(url("toh_hrm/api/remind-month-loan-capital")); ?>',
                        data:data, 
                        dataType: 'json',
                        beforeSend: function() {
                            $(".ajax_waiting").addClass("loading");
        ...
        function reviewFile(){  
            Swal.fire({
                ...
                if(result.value){   
                    ...
                    $.ajax({
                        method: "POST",
                        url: '<?php echo e(url("toh_hrm/api/approved-file")); ?>',
                        data:data, 
                        dataType: 'json',
                        beforeSend: function() {
                            $(".ajax_waiting").addClass("loading");
