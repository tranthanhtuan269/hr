			...
			<div class="row">
				<div class="col-lg-offset-1 col-lg-9">
					<form class="form-horizontal" method="post" action="" >
						...
						<?php if($data->type != 9 && $data->type != 10): ?> 
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" name="mail_subject" value="<?php echo e(old('mail_subject',isset($data->mail_subject) ? $data->mail_subject : null )); ?>" required>
							</div>
						</div>
						<div class="form-group">
							<label for="mail_content" class="col-sm-4 control-label">Nội dung mail</label>
							<div class="col-sm-8">
							  	<textarea rows="4" onkeydown="expandtext(this);" name="mail_content" class="form-control" requried><?php echo e(old('mail_content',isset($data->mail_content) ? $data->mail_content : null )); ?></textarea>
...
<!-- 						Nếu là loại Gửi Email thông báo xét tăng lương vs Cấu hình Email báo cho quản lý khi n/v đánh giá xét tăng lương xong thì bỏ phầm mày( Ko cần thiết ) -->
						<?php if($data->type != 3 && $data->type != 4): ?> 
							<?php if($data->type != 9 && $data->type != 10 && $data->type != 11  && $data->type != 12 && $data->type != 13): ?> 
							<div class="form-group">
								...
								<div class="col-sm-8">
		                            <select name="mail_to[]" id="my-select-mail-to" multiple="multiple" >
		                                <?php foreach($listPersonnel as $key=>$value): ?>
		                                     <option value="<?php echo e($value['id']); ?>" <?php echo ( isset($listPersonnel[$key]['ticket']) && $listPersonnel[$key]['ticket']==1 )?"selected":""; ?> ><?php echo e($value['fullname']); ?></option>
		                                <?php endforeach; ?>
		                            </select>
