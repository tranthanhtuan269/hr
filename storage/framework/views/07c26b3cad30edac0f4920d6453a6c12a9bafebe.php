...
<div class="row content-Emonth">
    <!-- Danh muc -->
    <?php /* <?php echo $__env->make('layouts.danhgia.menuleft.danhgianam', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?> */ ?>
    <div class="col-sm-2">
    </div>
    <div class="col-sm-10">
                ...
                <?php if(Auth::user()->id == 1): ?>
                    ...
                    <script>
                        function updatedAllFaith(){  
                            ...
                            $.ajax({
                                method: "POST",
                                url: '<?php echo e(url("toh_hrm/api/update-all-evaluate-faith")); ?>',
                                data:data, 
                                dataType: 'json',
                                beforeSend: function() {
        ...
        <?php if(count($data) > 0): ?>
            <?php /* <div class="alert alert-warning fade in alert-dismissible">
                ...
                <tbody>
                    <?php foreach($data as $personnel): ?>
                        <tr>
                            ...
                            <td class="text-center"><?php echo e($personnel->score_seniority); ?></td>
                            <td class="text-center"><?php echo e($personnel->score_position); ?></td>
                            <td class="text-center"><?php echo e($personnel->score_faith - ($personnel->score_seniority +  $personnel->score_position)); ?></td>
                            <td class="text-center score_faith"><?php echo e($personnel->score_faith); ?></td>
                            <td class="text-center">
                                <?php if(Auth::user()->id == 1): ?>
                                    <button data-pesonnel_id="<?php echo e($personnel->id); ?>" type="button" class="btn btn-xs btn-primary" data-toggle="modal" data-target="#evaluateFaithByCEO" > GĐ sửa trực tiếp </button>
                                ...
                                <?php endif; ?>
                                <?php if($personnel->score > 0): ?>
                                    <?php if(Auth::user()->id == 1): ?>
                                        <button data-pesonnel_id="<?php echo e($personnel->id); ?>" data-score="<?php echo e($personnel->score); ?>" data-note="<?php echo e($personnel->note); ?>" type="button" class="btn btn-xs btn-success approvedEvaluateFaith" data-toggle="modal" data-target="#approvedEvaluateFaith" > Phê duyệt đề xuất từ TTT</button>
                                    <?php else: ?>
                                ...
                                <?php else: ?>
                                    ...
                                    <?php endif; ?>
                                <?php endif; ?>
                                <button data-pesonnel_id="<?php echo e($personnel->id); ?>" type="button" class="btn btn-xs btn-info" data-toggle="modal" data-target="#myModal_view<?php echo e($personnel->id); ?>" > Xem hồ sơ </button>
                            </td>
                        </tr>
                        <!--  DETAIL POPUP FUNDS -->
                                ...
                                <div class="modal-content clearfix">
                                    ...
                                    <div style="padding: 20px;">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <?php echo BatvHelper::getSeniority($personnel->id); ?>
            ...
            <script>
                ...
                function evaluateFaithByCEO(){
                    ...
                    $.ajax({
                        method: "POST",
                        url: '<?php echo e(url("toh_hrm/api/evaluate-faith-by-ceo")); ?>',
                        data:data, 
                        dataType: 'json',
                        beforeSend: function() {
                            $(".ajax_waiting").addClass("loading");
