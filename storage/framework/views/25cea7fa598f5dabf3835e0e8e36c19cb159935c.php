...
<div class="row content-function">
	<?php /* <?php echo $__env->make('layouts.hoso.menuleft', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?> */ ?>
	<div class="col-xs-12 col-lg-offset-2 col-lg-10">
		<div class="row">
			...
			<div class="col-lg-12">
				<h4 class="title-fuction">Danh sách nhân viên trực thuộc <a href="#" style="color: #333; text-decoration: none; cursor: initial; font-size:13px"><input type="checkbox" value="1" <?php if(Request::get('type')== 'hidden'): ?> checked <?php endif; ?>> Ẩn NV đã nghỉ</a></h4>
				<?php if( count($data)>0 ): ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" data-toggle="modal" data-target="#myModalViewFile" 
                                            ...
                                            data-fullname="<?php echo e($fullname); ?>"
                                            data-gender="<?php echo e($gender); ?>"
                                            data-birthday="<?php echo e($birthday); ?>"
                                            data-phone_number="<?php echo e($phone_number); ?>"
                                            data-indentity_card_id="<?php echo e($indentity_card_id); ?>"
                                            data-indentity_card_date="<?php echo e($indentity_card_date); ?>"
                                            data-indentity_card_address="<?php echo e($indentity_card_address); ?>"
                                            data-jobs="<?php echo e($jobs); ?>"
                                            data-quy="<?php echo e($quy); ?>"
                                            data-time_attendance_machine="<?php echo e($time_attendance_machine); ?>"
                                            data-date_in="<?php echo e($date_in); ?>"
                                            data-salary_frequency="<?php echo e($salary_frequency); ?>"
                                            data-str_contracts="<?php echo e($str_contracts); ?>"
                                            data-title_department="<?php echo e($title_department); ?>"
                                            data-insurrance="<?php echo e($insurrance); ?>"
                                            data-home_town="<?php echo e($home_town); ?>"
                                            title="Xem chi tiết">
                                            <img src="<?php echo e(asset('images/general/eye.png')); ?>">
                                        </a>
                                    </td>  
                                </tr>
                                <?php $stt++; ?>
...
<script>
    $(document).ready(function(){
        $('#myModalViewFile').on('shown.bs.modal', function (e) {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo e(route('getFilePersonnelByMangerAjax')); ?>", 
...
<div id="myModalViewFile" class="modal fade" role="dialog">
  ...
  <script>
    $(document).ready(function() {
      var url = "<?php echo e(route('getFilePersonnelByManger')); ?>"
