						     	...
						     	<?php foreach($data as $val): ?>
									...
									?>
							     	<?php foreach( $others['list'][$val->personnel_id]['income_value'] as $k=>$v ): ?>
										...
										<?php if( !empty($v) ): ?>
	<!-- 													<span style="font-size: 12px;"><?php echo e($k); ?></span> : <b><?php echo e(BatvHelper::formatPrice($v)); ?></b> <br> -->
											<?php $total_item += $v; ?> 
										<?php endif; ?>
									<?php endforeach; ?>
									<?php
									...
									?>
						     		<!-- Chính thức -->
						     		<?php if( $val->salary_official_work > 0 && $val->salary_trial_work == 0 && $val->salary_parttime_work == 0 && $val->salary_trainee_work == 0 ): ?>
									    <tr>
											...
											<td><?php echo e(BatvHelper::getInfoRatioInSalary($numberDate,$val->personnel_id)); ?></td>
											<td>-</td>
										...
										?>
											...
											<td>
												<?php if( ($val->insurance)>0): ?>
												-<?php echo e(BatvHelper::formatPrice($val->insurance)); ?>
											...
											<td>
												<?php echo e(BatvHelper::formatPrice($val->salary_overtime)); ?>
								    ...
								    <!-- Thử việc -->
								    <?php elseif( $val->salary_trial_work> 0 && $val->salary_official_work  == 0 && $val->salary_parttime_work == 0 && $val->salary_trainee_work == 0 ): ?>
									     <tr>
									      	<td class="text-nowrap" scope="row"> <?php echo e(str_limit( $val->fullname, $limit = 35, $end = '...')); ?> </td> 
											...
											<td>0</td><!-- Lương lần 1 -->
											<td></td><!-- Lương lần 2 -->
											<td><?php echo e(BatvHelper::formatPrice( $val->salary_overtime + $val->salary_trial_work+$val->management_allowance+$val->work_bonus-$val->money_work_late+$val->parking_fee_allowance+$total_item+$val->mulct_money_awol-$val->party_fee+$val->holiday_bonus)); ?></td><!-- Thực nhận -->
									    </tr>
						     		<!-- Parttime -->
						     		<?php elseif( $val->salary_parttime_work > 0 && $val->salary_trial_work == 0 && $val->salary_official_work == 0 && $val->salary_trainee_work == 0 ): ?>
									    <tr>
											<td class="text-nowrap" scope="row"> <?php echo e(str_limit( $val->fullname, $limit = 35, $end = '...')); ?> </td> 
											...
											<td></td>
											<td></td>
											<td><?php echo e(BatvHelper::formatPrice($val->salary_overtime + $val->salary_parttime_work+$val->management_allowance+ $val->lunch_allowance+ $val->travel_allowance+$val->phone_allowance+$val->movement_allowance+$val->work_bonus-$val->insurance-$val->money_work_late-$val->welfare_fund+$val->parking_fee_allowance+$total_item+$val->other_tax_allowance+$val->laptop_allowance+$val->mulct_money_awol-$val->party_fee+$val->holiday_bonus)); ?></td><!-- Thực nhận -->
									    </tr>
						     		<!-- Thực tập fulltime-->
						     		<?php elseif( $val->salary_trainee_work > 0 && $val->salary_trial_work == 0 && $val->salary_official_work == 0 && $val->salary_parttime_work == 0 ): ?>
									    <tr>
											<td class="text-nowrap" scope="row"> <?php echo e(str_limit( $val->fullname, $limit = 35, $end = '...')); ?> </td> 
											...
											<td>0</td><!-- Lương lần 1 -->
											<td></td><!-- Lương lần 2 -->
											<td><?php echo e(BatvHelper::formatPrice($val->salary_overtime + $val->salary_trainee_work+$val->management_allowance+ $val->lunch_allowance+ $val->travel_allowance+$val->phone_allowance+$val->movement_allowance+$val->work_bonus-$val->insurance-$val->money_work_late-$val->welfare_fund+$val->parking_fee_allowance+$total_item+$val->other_tax_allowance+$val->laptop_allowance+$val->mulct_money_awol-$val->party_fee+$val->holiday_bonus)); ?></td><!-- Thực nhận -->
									    </tr>
						     		<!-- Thực tập Parttime-->
						     		<?php elseif( $val->salary_trainee_parttime_work > 0 && $val->salary_trial_work == 0 && $val->salary_official_work == 0 && $val->salary_parttime_work == 0 && $val->salary_trainee_work == 0): ?>
									    <tr>
											...
											<td>0</td><!-- Lương lần 1 -->
											<td></td><!-- Lương lần 2 -->
                                        	<td><?php echo e(BatvHelper::formatPrice($val->salary_overtime + $val->salary_trainee_parttime_work+$val->management_allowance+ $val->lunch_allowance+ $val->travel_allowance+$val->phone_allowance+$val->movement_allowance+$val->work_bonus-$val->insurance-$val->money_work_late-$val->welfare_fund+$val->parking_fee_allowance+$total_item+$val->other_tax_allowance+$val->laptop_allowance+$val->mulct_money_awol+$val->holiday_bonus-$val->party_fee)); ?></td><!-- Thực nhận -->
									    </tr>
									    <!-- Nửa này nửa kia -->
									    <?php else: ?>
									    	<?php
								    		...
								    		<?php if( $val->salary_trial_work >0 && ( $val->salary_trainee_work >0 || $val->salary_trainee_parttime_work >0  || $val->salary_official_work >0 || $val->salary_parttime_work >0 ) ): ?>
												...
												?>
											     <tr>
													...
													<td> -</td>
													<td rowspan="2"><?php echo e(BatvHelper::formatPrice($val->salary_overtime)); ?></td><!-- Lương làm thêm giờ -->
													<td rowspan="2" style="padding: 25px 0;"></td><!-- Trả nợ định kỳ kỳ vay vốn -->
													<td>0</td><!-- Lương lần 1 -->
													<td></td><!-- Lương lần 2 -->
													<td><?php echo e(BatvHelper::formatPrice( $val->salary_trial_work+$val->parking_fee_allowance +$val->holiday_bonus-$val->party_fee)); ?></td><!-- Thực nhận -->
											    </tr>
											    <tr>
									    	...
									    	<?php if( $val->salary_trainee_work >0 && ( $val->salary_official_work >0 || $val->salary_trainee_parttime_work >0  || $val->salary_parttime_work >0 ) ): ?>
												...
												?>
											     <tr>
													...
													<td>0</td><!-- Lương lần 1 -->
													<td></td><!-- Lương lần 2 -->
													<td><?php echo e(BatvHelper::formatPrice( $val->salary_trainee_work+$val->holiday_bonus-$val->party_fee)); ?></td><!-- Thực nhận -->
									    	...
									    	<?php if( $val->salary_parttime_work >0 && ( $val->salary_official_work >0 || $val->salary_trainee_parttime_work >0  )  ): ?>
												...
												?>
											     <tr>
													...
													<td>0</td><!-- Lương lần 1 -->
													<td></td><!-- Lương lần 2 -->
													<td><?php echo e(BatvHelper::formatPrice( $val->salary_parttime_work+$val->holiday_bonus-$val->party_fee)); ?></td><!-- Thực nhận -->
	                                        ...
	                                        <?php if( $val->salary_trainee_parttime_work >0 && $val->salary_official_work >0 ): ?>
	                                        	...
	                                        	?>
	                                             <tr style="background: #aadcaa;" >
	                                                <td class="text-nowrap" scope="row" style="border-bottom: 1px solid #fff;"> <?php echo e(str_limit( $val->fullname, $limit = 35, $end = '...')); ?> </td> 
													...
													<td>0</td><!-- Lương lần 1 -->
													<td></td><!-- Lương lần 2 -->
	                                                <td><?php echo e(BatvHelper::formatPrice( $val->salary_trainee_parttime_work +$val->holiday_bonus-$val->party_fee)); ?></td><!-- Thực nhận -->
	                                            </tr>
	                                            <tr style="background: #aadcaa;">
	                                            	<td></td>
	                                                <td><?php echo e(BatvHelper::formatPrice($val->salary_official_default)); ?></td>
