			...
			<div class="row">
			    ...
			    <div class="col-lg-12">
			        <h4 class="title-fuction">Danh sách công thức  
						<?php if(in_array('luongthuong-themcauhinhcongthuc',$arr_route)): ?>
							<a href="<?php echo e(route('addRecipeConfig')); ?>"><img src="<?php echo e(asset('images/general/add.png')); ?>"></a>
						<?php endif; ?>
			        </h4>
			          ...
			          <table class="table table-hover">
			            <tbody>
			              ...
			              <tr>
			                ...
			                <td><?php echo e(BatvHelper::getTypeIncomeConfigs($val->type)); ?></td>
			                <td><?php echo e(BatvHelper::getTypeParameters($val->is_fixed)); ?></td>
			                <td><?php echo e(str_limit( $val->value, $limit = 45, $end = '...')); ?></td>
			                <td>
								<?php if(in_array('luongthuong-suacauhinhcongthuc',$arr_route)): ?>
			                  		<a class="btn-edit" href="<?php echo e(route('editRecipeConfig',['id'=>$val->id ])); ?>"><img src="<?php echo e(asset('images/general/edit.png')); ?>"></a>
								<?php endif; ?>
								<?php if(in_array('luongthuong-xoacauhinhcongthuc',$arr_route)): ?>
			                  		<a class="btn-delete" href="<?php echo e(route('deleteRecipeConfig',['id'=>$val->id])); ?>" onclick="return confirm('Bạn có chắc chắn muốn xóa ?')"><img src="<?php echo e(asset('images/general/remove.png')); ?>"></a>
								<?php endif; ?>
			                </td>  
			              </tr>
			              	<?php $i++ ?>
