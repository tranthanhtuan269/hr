								        ...
								        ?>
										     	...
										     	<?php foreach($data as $v): ?>
												     <tr class="message-box text-center" id="message_<?php echo e($v->id); ?>">
														...
														<td class="message-money_tax"><?php echo e(BatvHelper::formatPrice($v->money_tax)); ?></td>
														<td class="message-percent_tax"><?php echo e($v->percent_tax); ?></td>
														<td class="message-money_minus"><?php echo e(BatvHelper::formatPrice($v->money_minus)); ?></td>
		...
		switch(action) {
			case "add":
				...
				if ( (!isNaN(money_tax) && money_tax>0) && (!isNaN(percent_tax) && percent_tax>0) && (!isNaN(money_minus) && money_minus>=0)){
					$.ajax({
					url: "<?php echo e(route('settingTaxAjax')); ?>",
					data:queryString,
					type: "GET",
