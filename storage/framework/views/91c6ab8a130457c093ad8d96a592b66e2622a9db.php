...
<?php $__env->startSection('content'); ?>
        ...
        <div class="col-lg-10">
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="text-center">
                        <?php if($detail_loan_capital[0]->disbursement_form == 1): ?>
                    ...
                    <td>
                        ...
                        <?php if($info_receive_disbursement  != ''): ?>
                            <textarea style="border:none"><?php echo $info_receive_disbursement; ?></textarea>
                        <?php endif; ?>
                    </td>
                    <td class="text-center">
                        <?php if($detail_loan_capital[0]->pay == 1): ?>
                            Trừ vào lương
                        <?php else: ?>
            ...
            <h4 class="title-fuction">
                ...
                <div class="pull-right" style="position: relative;bottom:5px;right:10px">
                    <?php /* <?php if($detail_loan_capital[count($detail_loan_capital) - 1]->status == 1 && $detail_loan_capital[0]->loan_capital_status != 4): ?>
                        <button type="button" class="btn btn-sm btn-warning" onclick="doneMonthLoanCapital()">Hoàn tất</button>
                    <?php endif; ?> */ ?>

                    <?php if($detail_loan_capital[0]->loan_capital_status == 4 ): ?>
            ...
            <table class="table table-bordered table-responsive">
                ...
                <tbody>
                    ...
                    <td class="text-center">
                        ...
                        ?>
                        <?php echo e(number_format($all_rest_1 )); ?>
            ...
            <h4 class="title-fuction">
                ...
                ?>
                <?php if($loan_capital_status != 4 && $user_id == 1): ?>
                    <div class="pull-right" style="position: relative;bottom:5px;right:10px">
                ...
                <tbody>
                    ...
                    <?php foreach($detail_loan_capital as $key => $item): ?>
                        <tr <?php if($item->status == 1): ?> style="background:#449d44;color:#fff" <?php endif; ?>>
                            ...
                            <td class="text-center">
                                <?php echo e(number_format(round($item->remaining_principal))); ?>
                            ...
                            <?php if($loan_capital_status != 4 && $pay == 2): ?>
                                <td class="text-center">
                                    <?php if($item->month > 0 && $item->status == 0 && $flag): ?>
                                        <?php if(in_array('quan-ly-tra-no-dinh-ky',$arr_route)): ?>
                                            <?php if(($final_settlement == 0 || $final_settlement == 2 ) && ($partial_settlement == 0 || $partial_settlement == 2)): ?>
                                                <?php
                                                    $received_date_user = $item->received_date_user;
                                                ?>
                                                <button data-month='<?php echo e($item->month); ?>' data-repayment_period='<?php echo e($repayment_period); ?>' data-paid_money='<?php echo e($total_tmp); ?>' type="button" class="btn-xs btn btn-primary btn-approvedMonthLoanCapital" data-toggle="modal" data-target="#approvedMonthLoanCapital">Cập nhật</button>
                                            <?php endif; ?>
                                            <?php 
                                                $flag = false;
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6 form-group">
                            ...
                            <input type="text" class="form-control input-sm"  name="received_date"  pattern="\d{1,2}/\d{1,2}/\d{4}" value="<?php echo e($received_date_user); ?>" autocomplete="off">
                            <script>
                                $(function() {
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-sm-4 form-group">
                            <label>Ngày nhận tiền:</label>
                            <input type="text" class="form-control input-sm"  name="received_date"  pattern="\d{1,2}/\d{1,2}/\d{4}" value="<?php echo e($detail_loan_capital[0]->final_settlement_date_user); ?>" autocomplete="off">
                            <script>
                                $(function() {
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-sm-4 form-group">
                            <label>Ngày nhận tiền:</label>
                            <input type="text" class="form-control input-sm"  name="received_date"  pattern="\d{1,2}/\d{1,2}/\d{4}" value="<?php echo e($detail_loan_capital[0]->partial_settlement_date_user); ?>" autocomplete="off">
                            <script>
                                $(function() {
    ...
    <script>
        $(document).on('click','.btn-approvedMonthLoanCapital',function(){
            ...
            $('#approvedMonthLoanCapital input[name=received_date]').val('<?php echo e($received_date_user); ?>');
        });
        ...
        $('#approvedFinalSettlement').on('shown.bs.modal', function (e) {
            ...
            var data = {
                        loan_capital_id : "<?php echo e(request()->route('loan_capital_id')); ?>",
                    };
            ...
            $.ajax({
                ...
                success: function (response) {
                    if(response.status == 200){
                        ...
                        $('#approvedFinalSettlement input[name=received_date]').val('<?php echo e($detail_loan_capital[0]->final_settlement_date_user); ?>');
        ...
        $('#approvedPartialSettlement').on('hidden.bs.modal', function (e) {
            ...
            $('#approvedPartialSettlement input[name=received_date]').val('<?php echo e($detail_loan_capital[0]->partial_settlement_date_user); ?>')
        })
        ...
        function approvedMonthLoanCapital(){
            ...
            $.ajax({
                method: "POST",
                url: '<?php echo e(url("toh_hrm/api/approved-pay-month-loan-capital")); ?>',
                data:data, 
                dataType: 'json',
                beforeSend: function() {
                    $(".ajax_waiting").addClass("loading");
        ...
        function approvedPartialSettlement(){
            ...
            $.ajax({
                method: "POST",
                url: '<?php echo e(url("toh_hrm/api/approved-partial-settlement")); ?>',
                data:data, 
                dataType: 'json',
                beforeSend: function() {
                    $(".ajax_waiting").addClass("loading");
        ...
        function approvedFinalSettlement(){
            ...
            $.ajax({
                method: "POST",
                url: '<?php echo e(url("toh_hrm/api/approved-final-settlement")); ?>',
                data:data, 
                dataType: 'json',
                beforeSend: function() {
                    $(".ajax_waiting").addClass("loading");
        ...
        function doneMonthLoanCapital(){
            ...
            .then(function (result) {
                if(result.value){   
                    ...
                    $.ajax({
                        method: "POST",
                        url: '<?php echo e(url("toh_hrm/api/done-pay-month-loan-capital")); ?>',
                        data:data, 
                        dataType: 'json',
                        success: function (response) {
                            if(response.status == 200){
