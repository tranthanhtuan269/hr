...
<div class="row content-function">
	...
	<div class="col-lg-10">
		<div class="row">
			<div class="col-lg-12">
				...
				<form class="form-horizontal" method="get" action="">
					<div class="form-group col-lg-6">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" name="title"  autocomplete="off" placeholder="Tên hợp đồng" value="<?php echo e(Request::get('title')); ?>">
						</div>
					</div>
					 <div class="form-group col-lg-6">
			...
			<div class="col-lg-12">
				<h4 class="title-fuction">Danh sách hợp đồng <!-- <a href="<?php echo e(route('addContract')); ?>"><img src="<?php echo e(asset('images/general/add.png')); ?>"></a> --></h4>
								...
								?>
						     	<?php foreach($data as $val): ?>
								     <tr>
								      ...
								      <td>
											<?php if(in_array('hoso-suahopdong',$arr_route)): ?>
									      	  <a class="btn-edit" href="<?php echo e(route('getContractEdit',['id'=>$val->id])); ?>"><img src="<?php echo e(asset('images/general/edit.png')); ?>"></a>
											<?php endif; ?>

		<!-- 							       <a class="btn-delete" href="<?php echo e(route('getContractDel',['id'=>$val->id])); ?>" onclick="return confirm('Bạn có chắc chắn muốn xóa ?')"> 
