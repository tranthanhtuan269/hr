		        ...
		        <form class="form-horizontal" method="get" action="">
			      ...
			      <div class="col-lg-12">
			        <h4 class="title-fuction">Danh sách nhóm người
						<?php if(in_array('luongthuong-themcauhinhnhomnguoi',$arr_route)): ?>
			          		<a href="<?php echo e(route('addGroupPersonalConfig')); ?>"><img src="<?php echo e(asset('images/general/add.png')); ?>"></a>
						<?php endif; ?>
			        </h4>
			        <?php if(count($data)>0 ): ?>
			          ...
			          <table class="table table-hover">
			            <tbody>
			              ...
			              <tr>
			                ...
			                <td>	
								<?php if(in_array('luongthuong-suacauhinhnhomnguoi',$arr_route)): ?>
					                <a class="btn-edit" href="<?php echo e(route('editGroupPersonalConfig',['id'=>$val->id ])); ?>"><img src="<?php echo e(asset('images/general/edit.png')); ?>"></a>
								<?php endif; ?>
								<?php if(in_array('luongthuong-xoacauhinhnhomnguoi',$arr_route)): ?>
					                <a class="btn-delete" href="<?php echo e(route('deleteGroupPersonalConfig',['id'=>$val->id])); ?>" onclick="return confirm('Bạn có chắc chắn muốn xóa ?')"> 
