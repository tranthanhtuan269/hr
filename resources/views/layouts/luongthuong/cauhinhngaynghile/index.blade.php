			...
			<div class="row">
			    ...
			    <div class="col-lg-12">
			        <h4 class="title-fuction">Danh sách ngày nghỉ lễ  
						@if(in_array('luongthuong-themngaynghile',$arr_route))
							<a href="{{ route('addHolidays') }}"><img src="{{ asset('images/general/add.png') }}"></a>
						@endif
			        </h4>
			            ...
			            <tbody>
							...
							?>
				              ...
				              <tr>
				                ...
				                <td>
									@if(in_array('luongthuong-suangaynghile',$arr_route))
					                  <a class="btn-edit" href="{{ route('editHolidays',['id'=>$val->id ]) }}"><img src="{{ asset('images/general/edit.png') }}"></a>
									@endif
									@if(in_array('luongthuong-xoangaynghile',$arr_route))
					                  <a class="btn-delete" href="{{ route('deleteHolidays',['id'=>$val->id]) }}" onclick="return confirm('Bạn có chắc chắn muốn xóa ?')"><img src="{{ asset('images/general/remove.png') }}"></a>
									@endif
				                </td>  
				              </tr>
				              	<?php $i++; ?>
