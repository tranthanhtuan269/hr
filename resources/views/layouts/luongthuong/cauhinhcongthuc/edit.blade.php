                                        ...
                                        $(document).ready(function(){
                                            $("#gender").change(function(){
                                                ...
                                                if( check_gender == 12 ){
                                                    ...
                                                    $('.repice_fixed_parent .fixed_special').append('<input type="number" class="form-control" name="recipe_fixed" step="" value="{{ old('value',isset($data->value) ? $data->value: null ) }}" max="100000000" required/>');
                                                }else{
                                                    $('.repice_fixed_parent .fixed_special input').remove();
                                                    $('.repice_fixed_parent .fixed_special').append('<input type="number" class="form-control" name="recipe_fixed" step="" value="{{ old('value',isset($data->value) ? $data->value: null ) }}" min="1" max="100000000" required="" />');
                                                }
                                            });
                                        });
                                    </script>
                                    @if( $data->type == 12 )
										<input type="number" class="form-control" name="recipe_fixed" step="" value="{{ old('value',isset($data->value) ? $data->value: null ) }}" max="100000000" required="" />
                                    @else
										<input type="number" class="form-control" name="recipe_fixed" step="" value="{{ old('value',isset($data->value) ? $data->value: null ) }}" min="1" max="100000000" required="" />
                                    @endif
			...
			<script type="text/javascript">
                ...
                $(document).ready(function() {
                    ...
                    $('#contactForm').submit(function(event) {
                            ...
                            var link = "{!! route('editRecipeConfigAjax') !!}";
                ...
                $('#mySelect').on('change', function() {
                    if( this.value == 0 ){
                    	...
                    	$('.repice_fixed').remove();
                    	$('.repice_fixed_parent').append('<div class="repice_fixed"><label class="col-sm-4 control-label">Giá trị <span class="required">*</span></label><div class="col-sm-6"><input type="number" class="form-control" name="recipe_fixed" step="" min="1" max="100000000" required="" value="{{ isset($data->value) ? $data->value: null  }}"/></div></div>');
