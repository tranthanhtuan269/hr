					...
					<form class="form-horizontal" method="post" action="" >
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								@for($i=1;$i<=12;$i++)
									<div class="checkbox">
									  <label><input type="checkbox" value="{{ $i }}" name="month[]" <?php if(  isset($data_detail[$i]['month']) && $data_detail[$i]['month']== $i ){ echo "checked"; } ?> >{{ $i }}</label>
									</div>
								@endfor
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input type="number" name="number_days" class="form-control" value="{{old('number_days',isset($data->number_days) ? $data->number_days: null )}}" min="0.5" max="1" step="0.5" required>
							</div>
						</div>
						<div class="form-group">
