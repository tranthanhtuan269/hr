...
<div class="row setting_salary">
		...
		<div class="col-lg-10">
			<h4 class="title-fuction">Cấu hình ngày nghỉ phép </h4> 
			@if(count($errors) > 0)
			...
			<div class="row">
			    ...
			    <div class="col-lg-12">
			        <h4 class="title-fuction">Danh sách ngày nghỉ phép
						@if(in_array('luongthuong-themngaynghiphep',$arr_route))
			          		<a href="{{ route('addLeave') }}"><img src="{{ asset('images/general/add.png') }}"></a>
						@endif
			         </h4>
			            ...
			            <tbody>
							...
							?>
				              ...
				              <tr>
				                ...
				                <td>
									@if(in_array('luongthuong-suangaynghiphep',$arr_route))
										<a class="btn-edit" href="{{ route('editLeave',['id'=>$val->id ]) }}"><img src="{{ asset('images/general/edit.png') }}"></a>
									@endif
									@if(in_array('luongthuong-xoangaynghiphep',$arr_route))
					                  	<a class="btn-delete" href="{{ route('deleteLeave',['id'=>$val->id]) }}" onclick="return confirm('Bạn có chắc chắn muốn xóa ?')"> <img src="{{ asset('images/general/remove.png') }}"></a>
									@endif
				                </td>  
				              </tr>
				              	<?php $i++; ?>
