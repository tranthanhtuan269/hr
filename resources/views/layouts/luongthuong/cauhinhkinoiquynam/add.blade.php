...
<!-- 				@if(in_array('luongthuong-themcauhinhkihieusuatnam',$arr_route))
			...
			<div class="row">
				...
				<div class="col-sm-12">
					<h4 class="title-fuction">Danh sách nhân viên tích cực tham gia các hoạt động, phong trào công ty năm {{ $year }}</h4>
						@if(count($errors) > 0)
...
<script type="text/javascript">
	...
	function doneEditKi(id) {
	    ...
	    var link = "{!! route('editKIRulesAjax') !!}";
        var data = {
            ki: ki,
            personnel_id: id,
            year:year,
