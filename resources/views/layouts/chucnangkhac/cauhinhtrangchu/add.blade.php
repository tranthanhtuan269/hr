...
<div class="row setting_salary">
		...
		<div class="col-lg-10">
			<h4 class="title-fuction">Thêm vùng hiển thị trang chủ </h4> 
			@if(count($errors) > 0)
					...
					<form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
				                ...
				                @if(!empty($data->icon))
				                  <img class="icon_cat_home" src="{{ asset('uploads/icon-categories/'.$data->icon) }}">
				                @endif
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input name="background_color" type="color" value="#2aa6e0">
							</div>
						</div>
						<div class="form-group">
