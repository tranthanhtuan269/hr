...
<div class="row content-function">
    ...
    <div class="col-lg-10">
        <div class="row">
            ...
            <div class="col-lg-12">
                <h4 class="title-fuction">Thêm nhân sự ký quỹ</h4>
               @if (count($errors) > 0)
                ...
                <form class="form-horizontal" method="POST" action="">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" pattern="\d{1,2}/\d{1,2}/\d{4}" class="datepicker form-control" name="received_date" value='<?php echo ( isset( $_POST["received_date"] ) )?$_POST["received_date"]:date("d/m/Y")?>'>
                        </div>
                    </div>
