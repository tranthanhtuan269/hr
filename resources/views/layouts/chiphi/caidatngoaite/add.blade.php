            ...
            <div class="col-lg-12">
				...
				<form  class="form-horizontal" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" pattern="\d{1,2}/\d{1,2}/\d{4}" class="datepicker form-control" name="apply_from" value=''>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-4 control-label">Thời gian hết hiệu lực <span class="required">*</span></label>
                        <div class="col-sm-5">
                            <input type="text" pattern="\d{1,2}/\d{1,2}/\d{4}" class="datepicker form-control" name="apply_to" value=''>
                        </div>
                    </div>
