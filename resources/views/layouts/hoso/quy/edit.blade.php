...
<div class="row content-function">
	...
	<div class="col-lg-7">
		<h4 class="title-fuction">Sửa khoảng thời gian nhân viên thuộc quỹ</h4>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    ...
                    <select name="funds_id" class="form-control">
                        ...
                        <option value="{{ $fund->id }}" <?php echo ( isset($data->funds_id) && $data->funds_id==$fund->id )? 'selected':''; ?>>{{ $fund->title }}</option>
                        @endforeach
                    </select>
                    @endif
                </div>
