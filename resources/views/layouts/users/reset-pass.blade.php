                ...
                <div style="width: 350px; margin: 0 auto; padding-top: 10px">
                    <form>
                        ...
                        <div class="form-group">
                            <label>Email</label>
                            <input type="email" class="form-control email" value="{{ Request::get('email') }}" disabled>
                        </div>
                        <div class="form-group">
                            <label>Code</label>
                            <input type="text" class="form-control code" value="{{ Request::get('reset_code') }}" disabled>
                        </div>
                        <div class="form-group">
