...
<div class="row content-function">
	<div class="col-lg-12">
		<h4 class="title-fuction">Sửa quá trình công tác</h4>
		...
		<form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
			...
			<div class="form-group col-lg-6">
				...
				<div class="col-sm-8">
					<input type="text" class="datepicker form-control" name="startDate" id="startDate" required @if ($errors->has('startDate')) autofocus value="" @else  value="{{ old('startDate',isset($data->date_start) ? $data->date_start : null)}}" @endif >
			...
			<div class="form-group col-lg-6">
				...
				<div class="col-sm-8">
					<input type="text" class="datepicker form-control" name="endDate" id="endDate" required @if ($errors->has('endDate')) autofocus value="" @else  value="{{ old('endDate',isset($data->date_end) ? $data->date_end : null)}}" @endif >
				</div>
			</div>
			<div class="form-group col-lg-6">
