...
<div class="row content-support">
	...
	<div class="col-lg-10">
		<h4 class="title-fuction">Thêm tiêu chí đánh giá</h4>
		@if(count($errors) > 0)
		...
		<form action="" method="post">
			<div class="form-group clearfix">
				<label class="col-sm-offset-2 col-sm-2 control-label text-right">Tên tiêu chí <span class="required">*</span></label>
				<div class="col-sm-6">
					<input type="text" class="form-control" name="criteria_content">
				</div>
			</div>
			<div class="form-group clearfix">
				<label class="col-sm-offset-2 col-sm-2 control-label text-right">Mô tả tiêu chí</label>
				<div class="col-sm-6">
					<textarea rows="4" onkeydown="expandtext(this);" class="form-control" name="description"></textarea>
				</div>
			</div>
