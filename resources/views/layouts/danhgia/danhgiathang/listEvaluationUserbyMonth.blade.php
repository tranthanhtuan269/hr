...
<div class="row content-Emonth">
    ...
    <div class="col-sm-10">
        <h4 class="title-fuction">Đánh giá KPI tháng <i class="fa fa-angle-double-right" aria-hidden="true"></i> Tự đánh giá</h4>
        ...
        ?>
        @if(!empty($param))
            <p><a href="{{ route('getEvaluationMonthbyUserEdit',['id'=>Auth::user()->id ]) }}" style="color: #ed7234;"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Chỉnh sửa</a></p>
        @endif
