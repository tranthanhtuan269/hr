...
<div class="row content-Emonth">
    ...
    <div class="col-sm-10">
        <h4 class="title-fuction">Đánh giá KPI tháng >> Chỉnh sửa đánh giá nhân viên trực thuộc</h4>
                ...
                <form action="" method="post">
                    <div class="table-responsive">
	                    ...
	                    <div class="form-group">
	                        <textarea rows="4" onkeydown="expandtext(this);" name="comment" onkeyup="textAreaAdjust(this)" >{{ $data[0]->comment }}</textarea>
	                    </div>
                    </div>
                    <div class="text-center">
