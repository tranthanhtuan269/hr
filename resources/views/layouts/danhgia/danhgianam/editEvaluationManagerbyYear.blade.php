...
<div class="row content-Emonth">
    ...
    <div class="col-sm-10">
        <h4 class="title-fuction">Đánh giá nâng lương <i class="fa fa-angle-double-right" aria-hidden="true"></i> Đánh giá quản lý <i class="fa fa-angle-double-right" aria-hidden="true"></i> Chỉnh sửa đánh giá quản lý</h4>
